export function Hero() {
  return (
    <section className="relative overflow-hidden px-10 py-16">
        ...
        <div className="flex items-center gap-[50px] w-full translate-x-24">
            {/* Left: copy */}
            <div className="w-fit h-fit font-display flex flex-col gap-[30px] text-nowrap text-[50px] py-10">
                ...
                <p className="text-[16px] font-sans leading-[25px] text-[#404040]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut <br></br> labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco <br></br> laboris nisi ut aliquip ex ea commodo consequat.
                </p>
